...
type ContextWithDispatchType<IContextType> = {
    state: IContextType,
...
export function createTypedActionContext<IContextType> (initialState: IContextType) {
    return createContext<ContextWithDispatchType<IContextType>>({state: initialState, dispatch: () => null});
}

export function createTypedActionContextProvider<IContextType>(
    initialState: IContextType,
    context: React.Context<ContextWithDispatchType<IContextType>>,
